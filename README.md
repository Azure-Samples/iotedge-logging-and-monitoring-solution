...
> Note: [Monitor alert architecture](#monitor-alerts-architecture-reference), Device Provisioning Service and [Distributed Tracing Sample](DistributedTracing) are not supported with the Terraform deployment.
